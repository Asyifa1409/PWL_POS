    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group row">
                <label class="col-1 control-label col-formm-label">Filter:</label>
                <div class="col-3">
                    ...
                    <small class="form-text text-muted">LevelPengguna</small>
                </div>
            </div>
        </div>
    </div>
...
id="table_user">
<thead>
<tr><th>ID</th><th>level kode</th><th>Nama level</th><th>Aksi</th></tr>
</thead>
</table>
</div>
</div>
