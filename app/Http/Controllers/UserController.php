...
class UserController extends Controller
{
    ...
    public function show(string $id) 
    {
        ...
        $activeMenu = 'user';
        return view('user.show', ['breadcrumb' => $breadcrumb, 'page' => $user, 'activeMenu' => $activeMenu]);
    ...
    public function edit(string $id) 
    {
        ...
        $activeMenu = 'user';
        return view('user.edit', ['breadcrumb' => $breadcrumb, 'page' => $page, 'activeMenu' => $activeMenu, 'user' =>$user]);
